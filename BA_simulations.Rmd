...
#m2 is best, next is m3, next is m1
m_gaus_simple <- add_criterion(m_simple, "loo")
m1_gaus <- add_criterion(m1, "loo")
m2_gaus <- add_criterion(m2, "loo")
m3_gaus <- add_criterion(m3, "loo")

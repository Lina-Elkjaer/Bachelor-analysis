...
# Simulate a population of "good" reaction times:
  ...
  rt_dist1_base <- rexgauss(50, mu=600, sigma=100, 200, positive = F)
  # keep positive values only:
  rt_dist1_base <- rt_dist1_base[rt_dist1_base > 0]

  rt_dist0_base <- rexgauss(50, mu=300, sigma=100, 200, positive = F)
  # keep positive values only:
...
get_prior(data = data, family = gaussian(), RT ~ 1 + gender)
...
#################################### M1 ############################################
 ...
 get_prior(data = data, family = gaussian(), RT ~ 1 + gender + (1| id))
...
get_prior(data = data, family = gaussian(), RT ~ 1 + gender + (1| gender) + (1|id))
...
get_prior(data = data, family = gaussian(), RT ~ 1 + gender + (1| gender:id))
...
pp_check(m4_gaus_prior, nsamples = 100)+
...
get_prior(data = data, family = gaussian(), RT ~ 1 + (1| gender) + (1| gender:id))
...
```{r EXGAUSSIAN MODELS}
get_prior(data = data, family = exgaussian(), RT ~ 1 + gender)
...
#################################### M1 ############################################
 ...
 get_prior(data = data, family = exgaussian(), RT ~ 1 + gender + (1| id))
...
get_prior(data = data, family = exgaussian(), RT ~ 1 + gender  + (1| gender:id))#+ (1| gender)
...
get_prior(data = data, family = exgaussian(), RT ~ 1 + gender + (1| gender) + (1|id))
...
get_prior(data = data, family = exgaussian(), RT ~ 1 + gender + (1| gender:id))
